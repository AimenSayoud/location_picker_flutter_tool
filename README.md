...
I made This plugin because [google_map_location_picker](https://pub.dev/packages/google_map_location_picker) deprecated .
...
The old package [google_map_location_picker](https://pub.dev/packages/google_map_location_picker)
